...
const Navbar = () => {
  ...
  return (
    <header className='fixed top-0 left-0 w-full bg-gray-900 bg-opacity-90 backdrop-blur-md shadow-lg z-40 translate-all duration-300 border-b border-emerald-800'>
      ...
      <div className='container mx-auto px-4 py-3'>
        ...
        <nav className='flex flex-wrap items-center gap-4'>
          ...
          {isAdmin && (
            ...
            transition duration-300 ease-in-out flext items-center' to={'/admin-page'}>
          ...
          {user?(
            ...
            <>
              <Link to={'/signup'} className='bg-emerald-600 hover:bg-emerald-700 text-white py-2 px-4 rounded-sm flex items-center transition duration-300 ease-in-out'>
                <UserPlus className='mr-2' size={18}/>
                  Sign Up
              </Link>
              <Link to={'/login'} className='bg-gray-700 hover:bg-gray-600 text-white py-2 px-4 rounded-sm flex items-center transition duration-300 ease-in-out'>
